      ...
      child: Column(
        children: [
          Row(
            ...
            children: const [
              _OrderType(0, 'كل الطلبات', ColorsManager.primary),
              _OrderType(1, 'تحت المعالجة', ColorsManager.warning),
              _OrderType(2, 'مكتملة', ColorsManager.success),
              _OrderType(3, 'ملغى', ColorsManager.danger),
            ],
          ),
...
class _OrderType extends GetView<OrdersController> {
  const _OrderType(
    this.index,
    this.text,
    this.color, {
