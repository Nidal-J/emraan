...
class CustomerAccountBalanceScreen extends GetView<CustomerPaymentController> {
  const CustomerAccountBalanceScreen({super.key});
...
class _PaymentCard extends GetView<CustomerPaymentController> {
  const _PaymentCard({
    Key? key,
    this.image,
