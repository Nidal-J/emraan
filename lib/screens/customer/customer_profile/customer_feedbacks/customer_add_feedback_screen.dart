...
import '../../../../getx/controllers/customer/customer_add_feedback_controller.dart';

class CustomerAddFeedbackScreen extends GetView<CustomerAddFeedbackController> {
  const CustomerAddFeedbackScreen({super.key});
