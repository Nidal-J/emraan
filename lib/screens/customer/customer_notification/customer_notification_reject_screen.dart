...
import '../../../getx/controllers/customer/customer_notifications_controller.dart';

class CustomerNotificationRejectScreen
    extends GetView<CustomerNotificationController> {
  const CustomerNotificationRejectScreen({super.key});
